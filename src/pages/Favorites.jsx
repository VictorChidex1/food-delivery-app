...
const Favorites = () => {
  ...
  // We compare string IDs to be safe as Firestore IDs are strings
      ...
      <AnimatePresence>
        {favoriteRestaurants.length === 0 ? (
          ...
          >
            ...
            <Link
              to="/"
              className="bg-[#FF5200] text-white px-8 py-3 rounded-xl font-bold hover:bg-orange-600 transition-transform hover:scale-105 shadow-lg"
            >
              Find Food
            </Link>
          </motion.div>
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        {restaurant.categories[0]} • {restaurant.deliveryTime}
                      </p>
                    </div>
                    <button
